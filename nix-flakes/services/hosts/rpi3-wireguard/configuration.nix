...

{
  ...
  networking.wireguard.interfaces = {
    ...
    wg0 = {
      ...
      postSetup = ''
        ${pkgs.iptables}/bin/iptables -t nat -A POSTROUTING -s 10.100.5.0/24 -o eth0 -j MASQUERADE
      '';

      # This undoes the above command
      postShutdown = ''
        ${pkgs.iptables}/bin/iptables -t nat -D POSTROUTING -s 10.100.5.0/24 -o eth0 -j MASQUERADE
      '';
